...
<head>
    ...
    <title>Web Design e SEO | YouSea - Marketing Digital</title>
</head>
<body id="top">
    ...
    <main>
        ...
        <section class="servicos-descricao" id="servicoWebsite">
            ...
            <div class="container sobre flex flex-align-center space-evenly">
                ...
                <div>
                    ...
                    <p><em>Os blogs continuam em crescimento, com mais de 409 milhões de pessoas visualizando mais de 23.6 bilhões de páginas por mês apenas no WordPress.</em></p>
                </div>
            </div>
            ...
            <div class="two-columns flex space-around website-layout">
                <div class="_600px">
                    <h3>Não tenho um Website/Blog</h3>
                    <h4><em>Layout e HTML</em></h4>
                    <p>Precisando criar um site? Damos vida a suas ideias e <strong>desenvolvemos um layout personalizado</strong> para o seu negócio. Planejamos, estruturamos e alinhamos com outras soluções que a YouSea oferece para disparar ao mundo digital o melhor cartão de visitas (e conversões) que o seu negócio poderia ter!</p>
                </div>
                <div class="_600px">
                    <h3>Já tenho um Website/Blog</h3>
                    <h4><em>Redesign e Manutenção</em></h4>
                    <p>Seu site está pesado, desorganizado e nada atrativo? Criamos um design de alto padrão com o <strong>redesenho do seu site</strong>, levando em consideração a experiência do usuário e a conversão de seus clientes. Alinhado a outras soluções da YouSea, otimizaremos seu endereço digital com o que há de mais moderno e eficiente em termos de conteúdo, design e funcionalidade.</p>
                </div>
            </div>
        ...
        <!-- Serviço - Otimização e Responsividade -->
                ...
                <div class="contato-form _600px">
                    ...
                    <form action="https://script.google.com/macros/s/AKfycbxUHPiT7cRN3hE96mmQN-zEPf8sTW_q54tKa9fB/exec" method="POST" id="gform">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="origem" value="Website SEO" style="display:none;" >
                        </div>
