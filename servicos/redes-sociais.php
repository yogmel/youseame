            ...
            <div>
                ...
                <div  class="container sobre flex flex-align-center space-evenly _960px">
                    ...
                    <div class="servicos-img-itens">
                        ...
                        <div>
                            <i class="fas fa-thumbs-up fa-2x"></i>
                            <p>O <strong>baixo custo das ações online</strong> são um diferencial diante do marketing tradicional (panfletos, propagandas em mídias sociais tradicionais, etc).</p>
                        </div>
                    </div>
                </div>
            </div>
