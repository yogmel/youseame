...
( function( $ ) {
	...
	wp.customize( 'setwood_text_color', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'setwood_header_link_color', function( value ) {
		value.bind( function( to ) {
			$( '.main-navigation ul li a, .site-title a, a.cart-contents, .site-header-cart .widget_shopping_cart a' ).css( 'color', to );
		} );
	} );
	wp.customize( 'setwood_header_background_color', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'setwood_footer_heading_color', function( value ) {
		value.bind( function( to ) {
			$( '.site-footer h1, .site-footer h2, .site-footer h3, .site-footer h4, .site-footer h5, .site-footer h6' ).css( 'color', to );
		} );
	} );
	wp.customize( 'setwood_footer_text_color', function( value ) {
		value.bind( function( to ) {
			$( '.site-footer' ).css( 'color', to );
		} );
	} );
	wp.customize( 'setwood_footer_link_color', function( value ) {
		value.bind( function( to ) {
			$( '.site-footer a:not(.button)' ).css( 'color', to );
		} );
	} );
	wp.customize( 'setwood_footer_background_color', function( value ) {
		value.bind( function( to ) {
