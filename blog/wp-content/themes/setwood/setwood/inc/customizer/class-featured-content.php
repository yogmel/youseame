<?php
/**
 * Setwood Featured Content
 *
 */
 
class Setwood_Featured_Content {
	...
	public static function init() {
		...
		add_filter( 'setwood_get_featured_content',       array( __CLASS__, 'get_featured_posts' )    );
	 ...
	 * Get featured posts
	 *
	 * @uses Setwood_Featured_Content::get_featured_post_ids()
	 *
	 * @return array
	 */
	...
	public static function get_featured_post_ids() {
		...
		if ( ! empty( $featured_ids ) ) {
			return array_map( 'absint', apply_filters( 'setwood_featured_content_post_ids', (array) $featured_ids ) );
		}
		...
		if ( $term ) {
			...
			return apply_filters( 'setwood_featured_content_post_ids', array() );
		}
		...
		return apply_filters( 'setwood_featured_content_post_ids', $featured_ids );
	}
	 ...
	 * @see Setwood_Featured_Content::validate_settings().
	 */
	 ...
	 *
	 * @uses Setwood_Featured_Content::get_featured_post_ids();
	 * @uses Setwood_Featured_Content::get_setting();
	 ...
	 * is deleted by Setwood_Featured_Content::validate_settings().
	 *
	 ...
	 *
	 * @uses Setwood_Featured_Content::validate_settings()
	 *
	 * @return void
	 */
	...
	public static function customize_register( $wp_customize ) {
		 ...
		 *
		 * Sanitization callback registered in Setwood_Featured_Content::validate_settings().
		...
		$wp_customize->add_control( 'featured-content[tag-name]', array(
			'label'          => esc_html__( 'Tag', 'setwood' ),
			'section'        => 'setwood_featured_content',
			'priority'       => 10,
			//'active_callback' => 'setwood_slider_activated_callback'
		) );
		$wp_customize->add_control( 'featured-content[hide-tag]', array(
			'label'          => esc_html__( 'Hide tag from displaying in post meta and tag clouds.', 'setwood' ),
			'section'        => 'setwood_featured_content',
			'type'           => 'checkbox',
			'priority'       => 11,
			//'active_callback' => 'setwood_slider_activated_callback'
		...
		$wp_customize->add_control( 'featured-content[show-all]', array(
			'label'          => esc_html__( 'Display featured posts in latest blog post listing.', 'setwood' ),
			'section'        => 'setwood_featured_content',
			'type'           => 'checkbox',
			'priority'       => 12,
			//'active_callback' => 'setwood_slider_activated_callback'
		...
		$wp_customize->add_control( 'featured-content[max-posts]', array(
			'label'          => esc_html__( 'Number of Posts', 'setwood' ),
			'section'        => 'setwood_featured_content',
			'type'           => 'text',
			'priority'       => 13,
			//'active_callback' => 'setwood_slider_activated_callback'
	...
	public static function enqueue_scripts() {
		wp_enqueue_script( 'setwood-featured-content-suggest', get_template_directory_uri() . '/assets/js/customizer/featured-content-admin.js', array( 'jquery', 'suggest' ), '20150401', true );
	}
	 ...
	 * Setwood_Featured_Content::get_featured_content().
	 *
	 * @uses Setwood_Featured_Content::delete_transient()
	 *
	 * @param array $input
	 * @return array $output
	 */
...
Setwood_Featured_Content::setup();
